	...
	$.ajax({
		...
		success: function (results) {
			...
			$.each(results, function (index, vehicle) {
				...
				row += '<tr><td> Exterior Color: ' + extColor + '</td><td> VIN:' + vin + '</td><td><a href="/Sales/Purchase/' + id + '"><button type="submit" class="btn btn-primary">Purchase</button></a></td></tr></table></div></div>'
